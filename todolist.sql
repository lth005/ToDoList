use todolist;
-- Dump completed on 2021-03-28 21:17:02


-- MySQL dump 10.13  Distrib 8.0.23, for Win64 (x86_64)
--
-- Host: localhost    Database: todolist2021
-- ------------------------------------------------------
...
-- Dump completed on 2021-03-28 21:17:04
...
CREATE TABLE `estado_tareas` (
  ...
  `nombre_estado_tarea` varchar(100) NOT NULL,
...
-- Dump completed on 2021-03-28 21:17:03
...
CREATE TABLE `usuarios` (
  ...
  KEY `fkidrol_idx` (`id_rol`),
  KEY `FKestado_idx` (`id_estado`),
  CONSTRAINT `FKestado` FOREIGN KEY (`id_estado`) REFERENCES `estados` (`idestado`),
  CONSTRAINT `FKidrol` FOREIGN KEY (`id_rol`) REFERENCES `roles` (`id_rol`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `listados` (
  ...
  KEY `idtarea_idx` (`id_tarea`),
  CONSTRAINT `idtarea` FOREIGN KEY (`id_tarea`) REFERENCES `tareas` (`id_tarea`),
...
-- Dump completed on 2021-03-28 21:17:01
...
CREATE TABLE `tareas` (
  ...
  KEY `FKestadotarea_idx` (`id_estado_tarea`),
  CONSTRAINT `FKestadotarea` FOREIGN KEY (`id_estado_tarea`) REFERENCES `estado_tareas` (`id_estado_tarea`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-03-28 21:17:00
